...
# Alias: CheckpointTrigger is the enum type for checkpoint triggers
# Tests expect isinstance(checkpoint.trigger, CheckpointTrigger) to work
CheckpointTrigger = CheckpointTriggerKind
