...
def mock_config():
    ...
    # Set min_execution_budget to 25.0 so budget check stops before 3rd goal
    # (after 2 goals @ 40.0 each = 80.0 spent, remaining = 20.0 < 25.0)
    config.min_execution_budget = 25.0
