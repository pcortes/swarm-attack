...
class TestSpecCriticEvaluate:
    ...
    def test_evaluate_truncates_long_spec(self):
        ...
        call_args = mock_llm.generate.call_args[0][0] if mock_llm.generate.call_args[0] else mock_llm.generate.call_args[1].get("prompt", "")
...
class TestSpecCriticFocusPrompts:
    ...
    def test_completeness_prompt_mentions_gaps(self):
        ...
        call_args = str(mock_llm.generate.call_args)
